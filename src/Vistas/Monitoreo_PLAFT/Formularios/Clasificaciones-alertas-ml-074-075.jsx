...
const Clasificaciones075 = () => {
    ...
    const eventos = () => {
        ...
        datos.append('herramienta','Clasificación De Alerta ML 074 - 075');
    ...
    const ONSUBMIT  = (e) => {
        ...
        //console.log(alertas)
            ...
            //Enviar Peticion
            fetch(url_server+'vista_monitoreo_plaft_ml_74_75',{
                method:'POST',
                body:datos
            }).then((resp)=>{
    ...
    return ( 
        ...
        <h2 
            className="font-black text-3xl text-center md:mr-2/3 mt-10 mb-5">Clasificacíon de Alertas Machine Learning
            <span className="text-indigo-600" > 074 - 075</span>
        </h2>
...
export default Clasificaciones075;